...
public class Champ {
    ...
    public Champ( FileReader r, int length,String name)throws WrongFileTypeException, EndOfFileException{
        this.name = name;
        ...
        for(int i =0; i<this.length; i++){
            ...
            if(currentChar==10 || currentChar == 13 || currentChar == 32 ){ //si on a un espace/fin de ligne/retour a la ligne 
                ...
                else{  if(currentChar == -1){ throw (new EndOfFileException());}
                    else {
    ...
    public String toString(){return name + " : " + octet ;}
    ...
    public int getInt_from_bits(int i){
        char c =octet.charAt(i);
        switch(c){
            case '0' : return 0;
            case '1' : return 1;
    ...
    private byte getbyte_from_byte(int i){
        char c =octet.charAt(i);
        switch(c){
            case '0' : return 0;
            case '1' : return 1;
